...
export const ZXSYNC_ERA_TESTNET_ID = 280

export const STORAGE_NETWORK_ID = process.env.NODE_ENV === 'production' ? BSC_ID : AVALANCHE_TESTNET_ID // ZXSYNC_ERA_TESTNET_ID//
